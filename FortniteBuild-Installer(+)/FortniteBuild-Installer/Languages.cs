...
╚═════╝░░╚═════╝░╚═╝╚══════╝╚═════╝░░░░░░░╚═╝╚═╝░░╚══╝╚═════╝░░░░╚═╝░░░╚═╝░░╚═╝╚══════╝╚══════╝╚══════╝╚═╝░░╚═╝" },
        ...
        // Ducki67
        public static Dictionary<string, string> Hungarian = new Dictionary<string, string>
        {
            { "welcome",@"
...
██████╦╝╚██████╔╝██║███████╗██████╔╝░░░░░░██║██║░╚███║██████╔╝░░░██║░░░██║░░██║███████╗███████╗███████╗██║░░██║
╚═════╝░░╚═════╝░╚═╝╚══════╝╚═════╝░░░░░░░╚═╝╚═╝░░╚══╝╚═════╝░░░░╚═╝░░░╚═╝░░╚═╝╚══════╝╚══════╝╚══════╝╚═╝░░╚═╝" },
            { "available_builds", "Íme az elérhető buildek listája:" },
            { "enter_choice", "Adja meg a letölteni kívánt build számát:" },
            { "invalid_choice", "Érvénytelen választás. Kérjük, próbálja újra." },
            { "build_choice", "Ön választotta:" },
            { "enter_path", "Adja meg az elérési utat, ahová ezt a buildet telepíteni szeretné:" },
            { "invalid_path", "Érvénytelen elérési út. Kérjük, próbálja újra." },
            { "downloading", "Letöltés ide:" },
            { "download_success", "A letöltés sikeresen befejeződött!" },
            { "download_error", "Hiba letöltés vagy kibontás közben:" },
            { "extracting", "Starting Extracting..." },
            { "extract_success", "A kivonás sikeresen befejeződött!" },
            { "press_key", "Nyomja meg bármelyik gombot a kilépéshez." },
        };
    }
}
